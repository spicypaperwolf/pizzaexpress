        ...
        <div class="container">
            <div class="row" style="padding: 50px">
                <form action="{{route('getNumber')}}" method="post">
                    @csrf
                <label for="orderNo">Your Order No.: &nbsp;</label>
                <input type="number" class="form-control" name="orderNo">
                    <button class="btn btn-primary" type="submit" style="margin-top: 40px;" value="getInvoice" name="submitBtn">Submit</button>
                    <button class="btn btn-primary" type="submit" style="margin-top: 40px; margin-left: 30px;" value="printInvoice" name="submitBtn">Print</button>
